...
GPT contains 96 multihead attention so $96 \times 3$
 matrix will be needed which can be reduced
...
<img src="assets/17. Multihead Attention/dim.png" width="300" /> 


- Each row corresponds to one token
- Each token is 6 dimension.

## Step 5: Unroll last dimension of Keys, Queries and Values to include $num_{head}$ and $head_{dim}$

$head\_dimension = \frac{d_{out}}{n_{head}} = \frac{6}{2} =3 $

<img src="assets/17. Multihead Attention/change.png" width="300" /> 
